...
计算机数学（math4cs）课程工具与配套材料。
Tools and supporting materials for the "Mathematics for Computer Science" course at Hunan University by Hengfeng Wei.

## 概述 | Overview

本仓库目前主要包含一个基于 LaTeX 编写的《计算机数学符号手册（中文）》。
This repository currently mainly contains a LaTeX-based Chinese handbook of mathematical symbols for the `math4cs` course.
